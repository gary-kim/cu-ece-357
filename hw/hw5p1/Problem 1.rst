...
c)
    The BSS region must be a minimum of 6 pages big. The beginning address for the BSS region is `08511000` and the ending address (that we know of) is `08516FFF`. There are 6 pages worth of space between those virtual addresses meaning the BSS region must be at least 6 pages big.
d)
